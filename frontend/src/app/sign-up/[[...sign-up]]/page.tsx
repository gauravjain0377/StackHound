...
export default function SignUpPage() {
  return (
    <div className="signup-container" style={{ minHeight: '100vh', display: 'flex', backgroundColor: '#000', color: '#fff', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', zIndex: 1, overflowY: 'auto' }}>
      ...
      <style>{`
        @media (max-width: 900px) {
          ...
          .signup-container > div:nth-child(2) { display: none !important; }
        }
      `}</style>
    </div>
  );
